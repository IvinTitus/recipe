...
urlpatterns = [
    ...
    path('recipes/', RecipeListCreateView.as_view(), name='create-review'),
    path('recipes/<int:pk>/', RecipeRetrieveUpdateDeleteView.as_view(), name='recipe-details'),
    path('recipes/search/', RecipeSearchView.as_view(), name='search-review'),
    path('recipes/<int:pk>/reviews/', ReviewListView.as_view(), name='list-review'),
    path('recipes/<int:pk>/reviews/create/', ReviewCreateView.as_view(), name='create-review'),
]
